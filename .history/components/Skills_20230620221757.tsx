...
<motion.div
  ...
  viewport={{ once: true }}
  className='flex flex-col mx-auto text-center justify-center w-screen h-screen overflow-hidden bg-green-500'>
    <div>
  <h3 className='font-semibold text-lg md:text-4xl uppercase tracking-[2px] text-gray-100 underline'>Here are some of the technologies I have recently been working with:</h3>

    </div>

  <div className='hidden flex-wrap overflow-auto justify-center md:flex bg-rose-500 md:h-[75%] md:'>
