...
<motion.div
  ...
  className='flex flex-col mx-auto text-center justify-center w-screen h-screen overflow-hidden bg-green-500'>
    <div>
  <h3 className='font-semibold text-lg md:text-5xl uppercase tracking-[2px] text-gray-100'>Here are some of the technologies I have recently been working with:</h3>
