...
function Contact({}: Props) {
  ...
  <div className='grid grid-cols-1 gap-[15px] md:w-1/2 bg-green-500 font-poppins'>
    ...
    <button type='submit' className='bg-blue-400 hover:bg-blue-500  rounded-6xl bg-midnightblue box-border w-[182px] h-[42px] flex flex-row items-center justify-center text-[16.51px] text-white border-[1.8px] border-solid border-color-text-dark hover:bg-gray-300 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110'>Submit
    </button>    
