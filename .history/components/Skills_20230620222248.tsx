...
<motion.div
  ...
  className='flex flex-col mx-auto text-center justify-center w-screen h-screen overflow-hidden bg-green-500'>
    <div>
  <h3 className='font-semibold text-lg md:text-4xl uppercase tracking-[2px] text-gray-100 underline'>Tools Of The Trade?</h3>

    </div>

  <div className='hidden flex-wrap overflow-auto justify-center md:flex bg-slate-300 md:h-[70%] rounded-2xl md:'>
