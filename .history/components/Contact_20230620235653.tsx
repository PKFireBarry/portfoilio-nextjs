...
function Contact({}: Props) {
  ...
  <div className='grid grid-cols-1 gap-[15px] h-[80%] md:w-1/2  font-poppins bg-[#a2c7f1] rounded-xl border-[4px] border-solid border-black  shadow-[0px_0px_15px_rgba(0,_0,_0,_0.8)] p-4 text-black'>
    ...
    <textarea rows={12} {...register('message')}  className='py-2 px-4 rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent text-base md:text-lg xl:text-2xl w-full bg-green-500' />
