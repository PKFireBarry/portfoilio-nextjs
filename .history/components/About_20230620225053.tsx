  ...
  <div className=" items-center flex ">
    <div className=" bg-black w-screen h-screen overflow-hidden">
      <div className="flex flex-col justify-center items-center h-screen w-screen">
        ...
        <div className=" w-[80%] md:w-[597px] h-[675px] flex flex-col items-center justify-center border-[4px] border-solid border-[#031463] shadow-[0px_0px_50px_rgba(0,_0,_0,_0.8)">
          <motion.div
