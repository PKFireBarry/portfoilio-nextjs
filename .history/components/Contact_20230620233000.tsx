...
function Contact({}: Props) {
  ...
  return (
    <div className='relative justify-center items-center h-screen w-screen '>
                ...
                <h3 className="font-semibold text-lg md:text-4xl uppercase tracking-[2px] text-black underline m-4 bg-green-500">
            Contact
          </h3>

<div className='mx-auto w-[85%] px-4 sm:px-6 lg:px-8 flex justify-center items-center text-black bg-rose-500'>

          <div className="flex flex-col items-start justify-start gap-[20px] md:w-1/2">
            <div className="relative  text-5xl">Let’s Talk</div>
          ...
          <div className="flex flex-col items-start justify-start gap-[20px] text-13xl">
            <b className="relative font-bold">Email</b>
          ...
          <div className="flex flex-col items-start justify-start gap-[20px] text-base">
            <b className="relative text-13xl">Socials</b>
  ...
  <div className='grid grid-cols-1 gap-16 md:w-1/2'>
