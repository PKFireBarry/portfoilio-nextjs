...
<motion.div
  ...
  className='w-screen flex flex-col
   items-center justify-center p-6 md:p-10 h-screen bg-black  text-gray-100'
>
  <a href={website}>
    <motion.img
  ...
  <motion.div
    ...
    className='bg-ghostwhite text-black rounded-lg shadow-lg w-full max-w-4xl mt-10'
  >
    <div className='p-8 md:p-12'>
      ...
      >
        <span className='border-b-4 border-midnightblue pb-2'>{title}</span>
      </motion.h3>
      <motion.p
        initial={{ opacity: 0, y: 50 }}
      ...
      <motion.a
        ...
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.1 }}
        className='bg-midnightblue hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-md text-center w-full text-sm md:text-base'
        href={link}
      >
        Github
      </motion.a>
