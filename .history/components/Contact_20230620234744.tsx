...
function Contact({}: Props) {
  ...
  <div className='grid grid-cols-1 gap-[15px] md:w-1/2  font-poppins bg-ghostwhite rounded-xl border-[4px] border-solid border-[#031463] shadow-[0px_0px_15px_rgba(0,_0,_0,_0.8)]'>
