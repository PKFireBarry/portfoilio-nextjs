...
const azure = '/azure-1.svg'
const npm = 'https://cdn.worldvectorlogo.com/logos/npm-square-red-1'
...
<motion.div
  ...
  className='flex flex-col mx-auto text-center justify-center w-screen h-screen overflow-hidden items-center'>
    <div>
  <h3 className='font-semibold text-lg md:text-4xl uppercase tracking-[2px] text-black underline'>Tools Of The Trade?</h3>

    </div>

  <div className='hidden flex-wrap overflow-auto items-center justify-center md:flex bg-black md:h-[70%] w-[85%] rounded-2xl md:'>
    ...
    <Skill icon {} Item='NPM' Description="a package manager for the JavaScript programming language"/>
  </div>
