...
<div className="relative justify-center items-center h-screen w-screen ">
  <div className="flex justify-center items-center pt-20">
    ...
    <p className='bg-green-500 text-xl md:hidden mx-auto w-[80%] text-black flex justify-center items-center'>
  ...
  <div className="mx-auto w-[85%] h-[85%] px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-center text-black md:flex-row">
    <div className="bg-rose-500 hidden md:flex flex-col items-start justify-start gap-[20px] md:w-1/2 flex-wrap">
      <div className="relative  text-6xl">Let’s Talk</div>
      <div className="relative text-xl inline-block w-full p-4">
        Have some big idea or brand to develop and need help? Then reach out{" "}
        {`we'd`} love to hear about your project and provide help
      </div>
    ...
    <div className="grid grid-cols-1 gap-[15px] w-[95%] md:w-1/2  font-poppins bg-[#a2c7f1] rounded-xl border-[4px] border-solid border-black  shadow-[0px_0px_15px_rgba(0,_0,_0,_0.8)]  md:p-4 text-black h-4/5">
