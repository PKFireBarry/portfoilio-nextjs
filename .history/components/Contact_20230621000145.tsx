...
<div className="relative justify-center items-center h-screen w-screen ">
  ...
  <div className="mx-auto w-[85%] h-[85%] px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-center text-black md:flex-row">
    ...
    <div className="grid grid-cols-1 gap-[15px] w-[85%] md:w-1/2  font-poppins bg-[#a2c7f1] rounded-xl border-[4px] border-solid border-black  shadow-[0px_0px_15px_rgba(0,_0,_0,_0.8)] p-4 text-black shrink-0">
