...
<div className="relative justify-center items-center h-screen w-screen ">
  <div className="flex justify-center items-center pt-20">
    ...
    <p className='bg-green-500 text-lg md:hidden mx-auto w-[80%] text-black flex justify-center items-center'>
    Have some big idea or brand to develop and need help? Then reach out{" "}
        {`we'd`} love to hear about your project and provide help
    </p>
    <div className='bg-orange-500 md:hidden'>
      <div className="flex flex-row  items-center justify-center gap-[20px] text-lg">
  ...
  <div className="mx-auto w-[85%] h-[85%] px-0 sm:px-6 lg:px-8 flex flex-col justify-center items-center text-black md:flex-row">
    <div className="bg-rose-500 hidden md:flex flex-col items-start justify-start gap-[20px] md:w-1/2 flex-wrap">
      ...
      <div className="flex flex-col items-start justify-start gap-[20px] text-13xl">
        ...
        <div className="relative text-base">barry0719@gmail.com</div>
      </div>
