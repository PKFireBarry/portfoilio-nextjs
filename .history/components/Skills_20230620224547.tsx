...
<motion.div
  ...
  <div className='hidden flex-wrap overflow-auto items-center justify-center md:flex bg-[#a2c7f1] md:h-[70%] w-[85%] rounded-2xl border-2 border-solid border-[#031463] shadow-[0px_0px_50px_rgba(0,_0,_0,_0.8)]'>
