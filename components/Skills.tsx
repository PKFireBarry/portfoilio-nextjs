  ...
  return (
    <>
      ...
      >
        ...
        <div className="hidden flex-wrap overflow-auto items-center justify-center md:flex bg-[#a2c7f1] md:h-[70%] w-[85%] rounded-2xl border-4 border-solid border-[#031463] shadow-[0px_0px_50px_rgba(0,_0,_0,_0.8)]">
          <Skill
            Icon={vscode}
            Item="VSCode"
          ...
          <Skill
            Icon={JS}
            Item="JS"
            Description="A high-level programming language used to create interactive websites"
          />
          <Skill
            Icon={python}
            Item="Python"
            Description="A popular programming language used for web development, data analysis, and artificial intelligence"
          />
          <Skill
            Icon={nodejs}
            Item="NodeJS"
          ...
          <Skill
            Icon={nextjs}
            Item="NextJS"
            Description="A framework for building server-side rendered React applications"
          />
          <Skill
            Icon={tailwind}
            Item="Tailwind"
          ...
          <Skill
            Icon={bootstrap}
            Item="Bootstrap"
            Description="A popular CSS framework for building responsive, mobile-first websites"
          />
          <Skill
            Icon={framer}
            Item="Framer Motion"
          ...
          <Skill
            Icon={muicss}
            Item="Material-Ui"
            Description="A popular React UI framework based on Googles Material Design"
          />
          <Skill
            Icon={jquery}
            Item="JQuery"
