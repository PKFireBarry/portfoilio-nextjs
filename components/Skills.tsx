...
text-gray-500 text-2xl pt-4'>Skills</h3>
        <h3 className=' absolute font-semibold top-36 uppercase tracking-[3px] text-gray-100 pt-10'>Here is a Grid of some of the technologies I have recently been working with:</h3>
        <div className='absolute grid grid-cols-4 gap-10'>
