...
function Contact({}: Props) {
  ...
  return (
    <div className='h-screen flex relative flex-col md:text-left md:flex-col max-w-4xl px-10 justify-evenly mx-auto items-center'>
        <h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl pt-4 pb-8'>Contact</h3>
        ...
        <div className='space-y-10 '>
            <div className='flex items-center space-x-5 justify-center'>
                ...
                <p className='text-2xl'>813-995-7019</p>
            </div>
                <div className='flex items-center space-x-5 justify-center'>
                ...
                <p className='text-2xl'>Barry0719@gmail.com</p>
            </div>
        </div>
        <div>
